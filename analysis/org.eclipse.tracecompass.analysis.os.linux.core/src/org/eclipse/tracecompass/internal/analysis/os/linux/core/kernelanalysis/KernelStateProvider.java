...
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.irq.IrqEntryHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.irq.IrqExitHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.PiSetprioHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.ProcessExitHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.ProcessForkHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.ProcessFreeHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.SwitchHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.sched.WakeupHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.softirq.SoftIrqEntryHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.softirq.SoftIrqExitHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.softirq.SoftIrqRaiseHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.statedump.StateDumpHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.syscall.SysEntryHandler;
import org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.syscall.SysExitHandler;
...
public class KernelStateProvider extends AbstractTmfStateProvider {
    ...
    public KernelStateProvider(ITmfTrace trace, IKernelAnalysisEventLayout layout) {
        ...
        fSysEntry = new SysEntryHandler(fLayout);
        fSysExit = new SysExitHandler(fLayout);
    }
    ...
    private static Map<String, IKernelEventHandler> buildEventNames(IKernelAnalysisEventLayout layout) {
        ...
        builder.put(layout.eventSchedSwitch(), new SwitchHandler(layout));
        ...
        for (String eventSchedWakeup : layout.eventsSchedWakeup()) {
            builder.put(eventSchedWakeup, new WakeupHandler(layout));
        }
