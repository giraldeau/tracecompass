...
package org.eclipse.tracecompass.internal.analysis.os.linux.core.kernelanalysis.kernelevenhandlers.syscall;
 ...
 */
public class SysEntryHandler extends AbstractKernelEventHandler {
    ...
    public void handleEvent(ITmfEvent event, ITmfStateSystemBuilder ss) throws AttributeNotFoundException {
        ...
        int currentCPUNode = getCurrentCPUNode(cpu, ss);
